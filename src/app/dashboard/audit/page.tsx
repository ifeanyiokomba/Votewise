...
const RESULT_TONE: Record<string, string> = {
  SUCCESS: "border-emerald-300 bg-emerald-50 text-emerald-700 dark:border-emerald-700 dark:bg-emerald-950/40 dark:text-emerald-300",
  ...
  CANCELLED: "border-amber-300 bg-amber-50 text-amber-700 dark:border-amber-700 dark:bg-amber-950/40 dark:text-amber-300",
};
                        ...
                        {l.result ? (
                          <span
                            className={cn(
                              ...
                              RESULT_TONE[l.result] ?? "border-border text-muted-foreground"
                            )}
                          >
